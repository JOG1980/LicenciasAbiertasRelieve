<?php 
	...
	$db_zotptx_sid = "DBE.PTXORA1";
	$db_zotptx_usuario = "rel";
	$db_zotptx_password = "rel";


	$query_zotptx_lic_anios_anteriores = "SELECT 
	...
	$query_zotptx_lic_este_anio_antes_rango = "SELECT 
											t_applications.SUBSTATION_NAME,	
											t_applications.EQP_TYPE,
											t_applications.EQP_SHORT_NAME,
											t_applications.APP_NUM,
	...
	$query_zotptx_lic_este_anio_en_rango = "SELECT 
											t_applications.SUBSTATION_NAME,	
											t_applications.EQP_TYPE,
											t_applications.EQP_SHORT_NAME,
											t_applications.APP_NUM,
